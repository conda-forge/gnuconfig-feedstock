...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gnuconfig-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11174&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gnuconfig-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gnuconfig` can be installed with:

```
conda install gnuconfig
```

It is possible to list all of the versions of `gnuconfig` available on your platform with:
